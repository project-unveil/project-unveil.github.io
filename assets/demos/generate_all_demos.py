...
DEMOS = [
    dict(id="dancing",      label="Dancing",      count=12593,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\240529\macarena_001__A545_M.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\240529\macarena_001__A545_M.bvh",
         gt  =dict(height=172, weight=68, age=38, gender="female"),
         pred=dict(height=168, weight=68, age=39, gender="female")),
    dict(id="walking",      label="Walking",      count=20222,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\240918\grab_walk_ff_180_001__A548.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\240918\grab_walk_ff_180_001__A548.bvh",
         gt  =dict(height=171, weight=62, age=29, gender="male"),
         pred=dict(height=175, weight=57, age=31, gender="male")),
    dict(id="jogging",      label="Jogging",      count=16437,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\240918\smoke_jog_ff_360_stop_R_001__A548.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\240918\smoke_jog_ff_360_stop_R_001__A548.bvh",
    ...
    dict(id="gesture",      label="Gesture",      count=15862,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\240529\neutral_alone_R_001__A542.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\240529\neutral_alone_R_001__A542.bvh",
         gt  =dict(height=179, weight=67, age=25, gender="male"),
         pred=dict(height=176, weight=62, age=22, gender="male")),
    dict(id="action",       label="Daily Action", count=13507,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\240529\neutral_itching_head_R_001__A542.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\240529\neutral_itching_head_R_001__A542.bvh",
         gt  =dict(height=179, weight=77, age=25, gender="male"),
         pred=dict(height=174, weight=73, age=28, gender="male")),
    dict(id="jumping",      label="Jumping",      count=11475,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\240527\neutral_dancecard_jump_002__A534.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\240527\neutral_dancecard_jump_002__A534.bvh",
         gt  =dict(height=179, weight=51, age=25, gender="male"),
         pred=dict(height=183, weight=57, age=28, gender="male")),
    dict(id="sitting",      label="Sitting",      count=5601,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\240918\sit_on_heels_loop_009__A548.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\240918\sit_on_heels_loop_009__A548.bvh",
         gt  =dict(height=171, weight=60, age=27, gender="female"),
         pred=dict(height=174, weight=56, age=30, gender="female")),
    dict(id="turning",      label="Turning",      count=3472,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\240918\idle_turn_000_R_long_002__A548.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\240918\idle_turn_000_R_long_002__A548.bvh",
         gt  =dict(height=171, weight=62, age=29, gender="female"),
    ...
    dict(id="climbing_box", label="Climbing Box", count=3402,
         ...
         gt  =dict(height=179, weight=70, age=25, gender="male"),
         pred=dict(height=175, weight=74, age=29, gender="male")),
    dict(id="standing_idle",label="Standing Idle",count=3190,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\230713\pull_shoudler_180_standing_R_001__A428.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\230713\pull_shoudler_180_standing_R_001__A428.bvh",
         gt  =dict(height=183, weight=52, age=27, gender="male"),
         pred=dict(height=187, weight=56, age=24, gender="male")),
    dict(id="kneeling",     label="Kneeling",     count=1731,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\230713\knightly_bow_R_001__A429.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\230713\knightly_bow_R_001__A429.bvh",
         gt  =dict(height=178, weight=90, age=25, gender="male"),
         pred=dict(height=173, weight=83, age=28, gender="male")),
    dict(id="crawling",     label="Crawling",     count=1384,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\230509\spider_crawl_R_001__A360.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\230509\spider_crawl_R_001__A360.bvh",
         gt  =dict(height=181, weight=73, age=28, gender="male"),
         pred=dict(height=177, weight=75, age=31, gender="male")),
    dict(id="exercising",   label="Exercising",   count=772,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\231019\squeak_003__A484.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\231019\squeak_003__A484.bvh",
         gt  =dict(height=167, weight=52, age=29, gender="male"),
         pred=dict(height=163, weight=57, age=26, gender="male")),
    dict(id="pulling",      label="Pulling",      count=702,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\231019\high_big_crank_ccw_002__A484.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\231019\high_big_crank_ccw_002__A484.bvh",
    ...
    dict(id="throwing",     label="Throwing",     count=316,
         g1 =r"C:\Users\sihat\Downloads\bones-seed\g1\csv\230424\throw_ball_R_001__A345.csv",
         bvh=r"C:\Users\sihat\Downloads\bones-seed\soma_uniform\bvh\230424\throw_ball_R_001__A345.bvh",
