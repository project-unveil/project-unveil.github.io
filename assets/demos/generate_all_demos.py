...
DEMOS = [
    dict(id="dancing",      label="Dancing",      count=12593,
         ...
         gt  =dict(height=172, weight=68, age=38, gender="male"),
         pred=dict(height=168, weight=68, age=39, gender="male")),
    ...
    dict(id="turning",      label="Turning",      count=3472,
         ...
         gt  =dict(height=171, weight=59, age=29, gender="male"),
         pred=dict(height=175, weight=63, age=32, gender="male")),
    ...
    dict(id="standing_idle",label="Standing Idle",count=3190,
         g1 =os.path.join(BONES_SEED, r"g1\csv\230713\pull_shoudler_180_standing_R_001__A428.csv"),
         bvh=os.path.join(BONES_SEED, r"soma_uniform\bvh\230713\pull_shoudler_180_standing_R_001__A428.bvh"),
    ...
    dict(id="exercising",   label="Exercising",   count=772,
         g1 =os.path.join(BONES_SEED, r"g1\csv\231019\squeak_003__A484.csv"),
         bvh=os.path.join(BONES_SEED, r"soma_uniform\bvh\231019\squeak_003__A484.bvh"),
    ...
    dict(id="pulling",      label="Pulling",      count=702,
         ...
         gt  =dict(height=167, weight=62, age=29, gender="female"),
         pred=dict(height=163, weight=56, age=33, gender="female")),
