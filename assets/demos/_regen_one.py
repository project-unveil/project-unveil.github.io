"""One-off: regen dancing_*.bin with female SMPL at 300 frames."""
...
PRED = dict(height=168, weight=68, gender="female")
GT   = dict(height=172, weight=68, gender="female")
